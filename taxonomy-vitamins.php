...
<div class="post-entry post-entry-type-page post-entry-1015">
	<div class="entry-content-wrapper clearfix">
		<div class="flex_column av_one_full  flex_column_div av-zero-column-padding first  avia-builder-el-0  el_before_av_two_third  avia-builder-el-first  "
			...
			<section class="av_textblock_section " itemscope="itemscope" itemtype="https://schema.org/CreativeWork">
				<div class="avia_textblock  " itemprop="text">
					<h1 class="term-heading">Vitamin <? echo $taxonomy->name; ?> rich vegetables, microgreens, and produce.</h1>
				</div>
			</section>
		</div>
		...
		<div class="flex_column av_one_third  flex_column_div   avia-builder-el-4  el_after_av_two_third  el_before_av_hr   column-top-margin"
			...
			<section class="av_textblock_section " itemscope="itemscope" itemtype="https://schema.org/CreativeWork">
				<div class="avia_textblock  " itemprop="text">
				<h5 style="text-align: center;">Vitamin <? echo $taxonomy->name; ?> helps</h5>
				<ul> 
				<?php
		...
		<div style="height:1rem" class="hr hr-invisible   avia-builder-el-6  el_after_av_one_third  el_before_av_hr  ">field
