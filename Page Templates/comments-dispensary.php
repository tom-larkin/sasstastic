	 ...
	 */
	 if(comments_open())
	 {
		...
		$css = ! empty( $args['extra_class'] ) ? $args['extra_class'] : '';
		 ...
		 echo "<{$heading} class='miniheading {$css}'>".__('Leave a Review','avia_framework')."</{$heading}>";
		 echo "<span class='minitext'>".__('Do you have an expericnce with this business that you would like to share?','avia_framework')." <br/>".__('Please leave an honest and detailed review','avia_framework')."</span>";
		 comment_form();
		 echo "</div>";
	 }
